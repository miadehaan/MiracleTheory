    ...
    return (
        <Form style={{  margin: '30px', fontSize: '30px' }} >
            ...
            <Form.Group controlId="exampleForm.ControlInput2">
                ...
                <Form.Control name="email" type="email" placeholder="name@example.com" onChange={props.handleInputChange} />
            </Form.Group>
            <Form.Group controlId="exampleForm.ControlTextarea1">
                <Form.Label>Message</Form.Label>
                <Form.Control name="message" as="textarea" rows={4} onChange={props.handleInputChange} />
            </Form.Group>
